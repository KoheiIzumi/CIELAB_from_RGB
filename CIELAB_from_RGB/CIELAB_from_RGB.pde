...
void setup()
{
  ...
  JTextField text_R = new JTextField("0");
  JLabel label_R = new JLabel("Green");
  JTextField text_G = new JTextField("0");
  JLabel label_G = new JLabel("Blue");
  JTextField text_B = new JTextField("0");
  ...
  int dialog = JOptionPane.showConfirmDialog(this, panel, "CIELAB from RGB", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
